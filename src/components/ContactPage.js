...
function ContactPage() {
    const paragraphs = [
        [
            "", 
            "Contact us through email at info@exchange.com!"
        ],
        [
            "Feedback?", 
        ...
        [
            ...
            + " For questions or concerns relating specifically to data and privacy, please see our Privacy Policy."
        ],
    ];

    return(
        <div className="Contact">
            {LinkPageContent("Contact Us", paragraphs)}
        </div>
    );
}
